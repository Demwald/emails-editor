...
var EmailsEditorController_1 = require("./Controller/EmailsEditorController");
require("./emails-editor.css");
function EmailsEditor(_a) {
    ...
    return new EmailsEditorController_1.default({ wrapper: wrapper, emailsInput: emailsInput });
}
